...
* by tls_suite_info.py on 2021-07-28
*
...
const std::vector<Ciphersuite>& Ciphersuite::all_known_ciphersuites()
   ...
   static const std::vector<Ciphersuite> g_ciphersuite_list = {
      ...
      Ciphersuite(0x1301, "AES_128_GCM_SHA256", Auth_Method::IMPLICIT, Kex_Algo::IMPLICIT, "AES-128/GCM", 16, "AEAD", 0, KDF_Algo::SHA_256, Nonce_Format::AEAD_IMPLICIT_4),
      Ciphersuite(0x1302, "AES_256_GCM_SHA384", Auth_Method::IMPLICIT, Kex_Algo::IMPLICIT, "AES-256/GCM", 32, "AEAD", 0, KDF_Algo::SHA_384, Nonce_Format::AEAD_IMPLICIT_4),
      Ciphersuite(0x1303, "CHACHA20_POLY1305_SHA256", Auth_Method::IMPLICIT, Kex_Algo::IMPLICIT, "ChaCha20Poly1305", 32, "AEAD", 0, KDF_Algo::SHA_256, Nonce_Format::AEAD_XOR_12),
      Ciphersuite(0x1304, "AES_128_CCM_SHA256", Auth_Method::IMPLICIT, Kex_Algo::IMPLICIT, "AES-128/CCM", 16, "AEAD", 0, KDF_Algo::SHA_256, Nonce_Format::AEAD_IMPLICIT_4),
      Ciphersuite(0x1305, "AES_128_CCM_8_SHA256", Auth_Method::IMPLICIT, Kex_Algo::IMPLICIT, "AES-128/CCM(8)", 16, "AEAD", 0, KDF_Algo::SHA_256, Nonce_Format::AEAD_IMPLICIT_4),
