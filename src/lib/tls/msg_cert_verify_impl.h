...
#ifndef BOTAN_TLS_CERT_VERIFY_IMPL_H_
#define BOTAN_TLS_CERT_VERIFY_IMPL_H_
...
class Certificate_Verify_Impl : public Handshake_Message
   ...
   public:
      ...
      */
      ...
      Certificate_Verify_Impl(const std::vector<uint8_t>& buf);

      virtual ~Certificate_Verify_Impl();
